...
namespace ValhallaVaultCyberAwareness.Client.Services
{
	public class SupportQuestionService : ISupportQuestionService
	{
		...
		public async Task<List<SupportQuestionViewModel>> GetAllSupportQuestionsAsync()
		{
			...
			if (apiResponse.IsSuccessStatusCode)
			{
				...
				{
					List<SupportQuestionViewModel> supportQuestions = allSupportQuestions.Select(s => new SupportQuestionViewModel(s)).ToList();
